<%-- 
    Document   : viewjobrecruiter
    Created on : Apr 21, 2020, 7:33:49 PM
    Author     : Siddharth
--%>
...
<link rel=stylesheet type = text/css href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <% 
    ...
    ResultSet rs = pDAO.viewjobpost(companyname); 
%>
...
<td><a style = "font-size : 10pt" href="deletejobpost.jsp?id=<%= rs.getString(1) %>">Delete</a></td>
